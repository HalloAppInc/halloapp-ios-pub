...
extension Server_IncomingCallPush: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 3: try { try decoder.decodeRepeatedMessageField(value: &self.stunServers) }()
      case 4: try { try decoder.decodeRepeatedMessageField(value: &self.turnServers) }()
      case 5: try { try decoder.decodeSingularInt64Field(value: &self.timestampMs) }()
      case 6: try { try decoder.decodeSingularMessageField(value: &self._callConfig) }()
      default: break
      }
    }
  }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if !self.stunServers.isEmpty {
      try visitor.visitRepeatedMessageField(value: self.stunServers, fieldNumber: 3)
    }
    if !self.turnServers.isEmpty {
      try visitor.visitRepeatedMessageField(value: self.turnServers, fieldNumber: 4)
    }
    if self.timestampMs != 0 {
