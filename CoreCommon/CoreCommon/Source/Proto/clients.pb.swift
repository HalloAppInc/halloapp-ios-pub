...
public struct Clients_ChatContainer {
  ...
  public var files: Clients_Files {
    get {
      if case .files(let v)? = message {return v}
...
public struct Clients_PostContainer {
  ...
  public var moment: Clients_Moment {
    get {
      if case .moment(let v)? = post {return v}
      return Clients_Moment()
    }
    set {post = .moment(newValue)}
  }

  public var commentKey: Data = Data()
...
public struct Clients_Files {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var files: [Clients_File] = []
...
public struct Clients_File {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var data: Clients_EncryptedResource {
    get {return _data ?? Clients_EncryptedResource()}
    set {_data = newValue}
  }
...
public struct Clients_EncryptedPayload {
  ...
  public var commentKeyEncryptedPayload: Data {
    get {
      if case .commentKeyEncryptedPayload(let v)? = payload {return v}
      return Data()
    }
    set {payload = .commentKeyEncryptedPayload(newValue)}
  }
  ...
  public enum OneOf_Payload: Equatable {
    ...
    case commentKeyEncryptedPayload(Data)
    ...
    public static func ==(lhs: Clients_EncryptedPayload.OneOf_Payload, rhs: Clients_EncryptedPayload.OneOf_Payload) -> Bool {
      ...
      case (.commentKeyEncryptedPayload, .commentKeyEncryptedPayload): return {
        guard case .commentKeyEncryptedPayload(let l) = lhs, case .commentKeyEncryptedPayload(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
      default: return false
      }
...
public struct Clients_Moment {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var image: Clients_Image {
    get {return _image ?? Clients_Image()}
    set {_image = newValue}
  }
...
extension Clients_Moment: @unchecked Sendable {}
...
extension Clients_PostContainer: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 5: try { try decoder.decodeSingularBytesField(value: &self.commentKey) }()
      default: break
      }
    }
  }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    case .moment?: try {
      guard case .moment(let v)? = self.post else { preconditionFailure() }
      try visitor.visitSingularMessageField(value: v, fieldNumber: 4)
    }()
    case nil: break
    }
    if !self.commentKey.isEmpty {
      try visitor.visitSingularBytesField(value: self.commentKey, fieldNumber: 5)
    }
    try unknownFields.traverse(visitor: &visitor)
  }
  ...
  public static func ==(lhs: Clients_PostContainer, rhs: Clients_PostContainer) -> Bool {
    ...
    if lhs.commentKey != rhs.commentKey {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
...
extension Clients_Container: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      ...
      try { if let v = _storage._commentContainer {
        try visitor.visitSingularMessageField(value: v, fieldNumber: 5)
      } }()
...
extension Clients_Video: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    try { if let v = self._streamingInfo {
      try visitor.visitSingularMessageField(value: v, fieldNumber: 4)
    } }()
    try unknownFields.traverse(visitor: &visitor)
  }
...
extension Clients_Files: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".Files"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "files"),
    2: .same(proto: "text"),
  ]
  ...
  public static func ==(lhs: Clients_Files, rhs: Clients_Files) -> Bool {
...
extension Clients_File: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
...
extension Clients_EncryptedPayload: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    3: .standard(proto: "comment_key_encrypted_payload"),
  ]
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 3: try {
        ...
        if let v = v {
          if self.payload != nil {try decoder.handleConflictingOneOf()}
          self.payload = .commentKeyEncryptedPayload(v)
        }
      }()
      default: break
      }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    case .commentKeyEncryptedPayload?: try {
      guard case .commentKeyEncryptedPayload(let v)? = self.payload else { preconditionFailure() }
...
extension Clients_Moment: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 1: try {
        ...
        if let v = v {
          if hadOneofValue {try decoder.handleConflictingOneOf()}
          self.contentID = .postIDContext(v)
        }
      }()
      case 2: try {
