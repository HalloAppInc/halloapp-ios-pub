...
extension Proto_Receipts.Receipt: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try decoder.decodeSingularMessageField(value: &self._timestampDelivered)
      case 3: try decoder.decodeSingularMessageField(value: &self._timestampSeen)
      default: break
      }
    }
  }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if let v = self._timestampDelivered {
      try visitor.visitSingularMessageField(value: v, fieldNumber: 2)
    }
    if let v = self._timestampSeen {
