...
extension MomentViewController: ContentInputDelegate {
    ...
    func inputView(_ inputView: ContentInputView, didPost content: ContentInputView.InputContent) {
        ...
        Task { @MainActor [weak self] in
            guard let message = await MainAppContext.shared.chatData.sendMomentReply(chatMessageRecipient: .oneToOneChat(post.userId), postID: post.id, text: text, media: content.media, files: content.files) else {
