...
class MessageCellViewAudio: MessageCellViewBase {
    ...
    private lazy var nameAudioTextTimeRow: UIStackView = {
        let vStack = UIStackView(arrangedSubviews: [ nameRow, audioRow, audioTimeRow ])
    ...
    private func configureCell() {
        if isOwnMessage {
            ...
            nameAudioTextTimeRow.layoutMargins =  UIEdgeInsets(top: 16, left: 6, bottom: 6, right: 6)
        } else {
            ...
            nameAudioTextTimeRow.layoutMargins =  UIEdgeInsets(top: 6, left: 6, bottom: 6, right: 6)
