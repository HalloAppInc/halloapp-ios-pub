...
public struct Server_IncomingCall {
  ...
  public var serverSentTsMs: Int64 = 0
...
extension Server_IncomingCall: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 7: try { try decoder.decodeSingularInt64Field(value: &self.serverSentTsMs) }()
      default: break
      }
    }
  }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if self.serverSentTsMs != 0 {
      try visitor.visitSingularInt64Field(value: self.serverSentTsMs, fieldNumber: 7)
    }
    try unknownFields.traverse(visitor: &visitor)
  }
  ...
  public static func ==(lhs: Server_IncomingCall, rhs: Server_IncomingCall) -> Bool {
    ...
    if lhs.turnServers != rhs.turnServers {return false}
    if lhs.timestampMs != rhs.timestampMs {return false}
    if lhs.serverSentTsMs != rhs.serverSentTsMs {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 34: try {
          ...
          try decoder.decodeSingularMessageField(value: &v)
          if let v = v {_storage._payload = .contactSyncError(v)}
        }()
        case 35: try {
          ...
          try decoder.decodeSingularMessageField(value: &v)
          if let v = v {_storage._payload = .clientOtpRequest(v)}
        }()
        case 36: try {
          ...
          try decoder.decodeSingularMessageField(value: &v)
          if let v = v {_storage._payload = .clientOtpResponse(v)}
        }()
        case 37: try {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 30: try {
          ...
          try decoder.decodeSingularMessageField(value: &v)
          if let v = v {_storage._payload = .playedReceipt(v)}
        }()
        case 31: try {
          ...
          try decoder.decodeSingularMessageField(value: &v)
          if let v = v {_storage._payload = .requestLogs(v)}
        }()
        case 32: try {
          var v: Server_WakeUp?
          if let current = _storage._payload {
          ...
          try decoder.decodeSingularMessageField(value: &v)
          if let v = v {_storage._payload = .wakeup(v)}
        }()
        case 33: try {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 1: try {
        ...
        try decoder.decodeSingularMessageField(value: &v)
        if let v = v {self.request = .otpRequest(v)}
      }()
      case 2: try {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 1: try {
        ...
        try decoder.decodeSingularMessageField(value: &v)
        if let v = v {self.response = .otpResponse(v)}
      }()
      case 2: try {
